...
$queryss = $db->prepare("UPDATE doctors SET doctorName=?, doctorSurname=?, username=?, passwordDoctor=?, dateOfBirth=?, address=?, telephoneNumber=?, patients=?,identityNumber=? ");
$queryss->execute(array($doctorName,$doctorSurname,$username,$password,$dateofbirth,$address,$telephoneNumber,$patients,$identityNumber));
...
$query->execute(array($doctorsID));
if($row = $query->fetch())
{
    
    $doctorName 				= $row['doctorName'];
	$doctorSurname 				= $row['doctorSurname'];
											...
											<form class="kt-form" id="kt_form"  method="post"  enctype="multipart/form-data">
	                                        	...
	                                        	<div class="col-md-6">   
													<div class="form-group">
														...
														<input type="text" id="complaintinput1" class="form-control " name="doctorName" value="<? echo $doctorName ?>">
	                                        	...
	                                        	<div class="col-md-6">   
													<div class="form-group">
														...
														<input type="text" id="complaintinput2" class="form-control "  name="doctorSurname" value="<? echo $doctorSurname ?>">
													</div>
												</div>
	                                        	...
	                                        	<div class="col-md-6">   
													<div class="form-group">
														...
														<input type="text" id="complaintinput1" class="form-control " name="username" value="<? echo $username ?>">
	                                        	...
	                                        	<div class="col-md-6">   
													<div class="form-group">
														...
														<input type="text" id="complaintinput2" class="form-control "  name="password" value="<? echo $password ?>">
													</div>
												</div>
	                                        	...
	                                        	<div class="col-md-6">   
													<div class="form-group">
														...
														<input type="text" id="complaintinput1" class="form-control " name="dateOfBirth" value="<? echo $dateofbirth ?>">
	                                        	...
	                                        	<div class="col-md-6">   
													<div class="form-group">
														...
														<input type="text" id="complaintinput2" class="form-control "  name="address" value="<? echo $address ?>">
													</div>
												</div>
															</div>
															<div class="row"> 
	                                        	<div class="col-md-6">   
													<div class="form-group">
														...
														<input type="text" id="complaintinput1" class="form-control " name="telephoneNumber" value="<? echo $telephoneNumber ?>" >
	                                        	...
	                                        	<div class="col-md-6">   
													<div class="form-group">
														...
														<input type="text" id="complaintinput2" class="form-control "  name="patients" value="<? echo $patients ?>">
													</div>
												</div>
															</div>
															<div class="row"> 
	                                        	<div class="col-md-6">   
													<div class="form-group">
														...
														<input type="text" id="complaintinput1" class="form-control " name="identityNumber" value="<? echo $identityNumber ?>" >
