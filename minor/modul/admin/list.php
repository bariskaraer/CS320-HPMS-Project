						...
						<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
							...
							<div class="kt-grid kt-grid--desktop kt-grid--ver kt-grid--ver-desktop kt-app">
								...
								<div class="kt-grid__item kt-grid__item--fluid kt-app__content">
									...
									<div class="row">
										 <?
											 		$query = $db->prepare("SELECT * FROM course_admin where course_adminID=?   " );
												$query->execute(array($_SESSION['course_adminID']));
					               					if($row = $query->fetch())
								   						{
												                      
										                     	$menames 		=$row["name"];
																$mesurnames	=$row["surname"];
																$meimage	=$row["image"];
																
											
													
																		$meimage = split ("\|", $meimage);  
														}
														
			                      $query = $db->prepare("SELECT * FROM course_admin where status=1 and course_adminID!=? and courseID=? order by course_adminID ASC " );
			                      $query->execute(array($_SESSION['course_adminID'],$dt_courseID));
			                      if ( $query->rowCount() ){
			                      foreach( $query as $row ){
										...
										$youcourse_adminID	=$row['course_adminID'];
										
										$younames 		=$row["name"];
										$yousurnames	=$row["surname"];
										$image	=$row["image"];
										$web =$row["webSignalID"];
										
					
							
												$youimage = split ("\|", $image);  
													...
													<div class="kt-widget kt-widget--user-profile-2">
														<div class="kt-widget__head">
															<div class="kt-widget__media">
																<img class="kt-widget__img kt-hidden-" src="data:image/jpg;base64,<? echo $youimage[0] ?>" alt="image">
															...
															<div class="kt-widget__info">
																<a href="#" class="kt-widget__username">
																	<? echo $younames ?> <? echo $yousurnames ?>
																</a>
														...
														<div class="kt-widget__body">
															<div class="kt-widget__item">
																<div class="kt-widget__contact">
																	...
																	<a href="#" class="kt-widget__data"><? echo $youemail ?></a>
																</div>
																<div class="kt-widget__contact">
																	<span class="kt-widget__label">Phone:</span>
																	<a href="#" class="kt-widget__data"><? echo $youphone ?></a>
																</div>
															</div>
														</div>
														<div class="kt-widget__footer">
															<a href="<? echo $url ?>/admins/profile/<? echo $youcourse_adminID ?>" class="btn btn-label-success btn-sm btn-upper">Profil</a>
														</div>
														<div class="kt-widget__footer">
																<button type="button" id="you" class="btn btn-label-warning btn-lg btn-upper" data-toggle="modal" data-target="#kt_chat_modal" value="<? echo $youcourse_adminID ?>">Mesaj Gönder</button>
														</div>
													</div>
