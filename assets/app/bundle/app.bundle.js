...
var KTDemoPanel = function() {
    ...
    var remind = function() {
        if (!(encodeURI(window.location.hostname) == 'crm.krakersoft.com' || encodeURI(window.location.hostname) == 'www.crm.krakersoft.com')) {
            return;
        }
...
var KTQuickSearch = function() {
    ...
    var processSearch = function() {
        ...
        setTimeout(function() {
            $.ajax({
                url: 'https://www.crm.krakersoft.com/api/quick_search',
                data: {
                ...
                error: function(res) {
                    ...
                    hideProgress();
                    KTUtil.addClass(target, resultClass);
                    KTUtil.setHTML(resultWrapper, '<span class="kt-quick-search__message">Bağlantı Hatası Lütfen Tekrar Deneyin..</div>');
                    showDropdown();
                    KTUtil.scrollUpdate(resultWrapper);
                }
            });
